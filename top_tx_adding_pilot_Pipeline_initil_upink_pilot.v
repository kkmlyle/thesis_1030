...
wire   [63:0] zext_ln56_fu_142_p1;
wire    ap_block_pp0_stage0;
wire   [63:0] i_8_cast_cast13_fu_159_p1;
reg   [9:0] i_8_fu_46;
wire   [9:0] zext_ln54_cast_fu_108_p1;
wire   [9:0] add_ln54_fu_148_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i;
wire   [9:0] sub_ln56_fu_126_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((icmp_ln54_fu_120_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
            i_8_fu_46 <= add_ln54_fu_148_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            i_8_fu_46 <= zext_ln54_cast_fu_108_p1;
        end
    end
end
...
always @ (*) begin
    if (((icmp_ln54_fu_120_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i = zext_ln54_cast_fu_108_p1;
    end else begin
...
assign add_ln54_fu_148_p2 = (ap_sig_allocacmp_i + 10'd4);
...
assign icmp_ln54_fu_120_p2 = ((ap_sig_allocacmp_i < 10'd600) ? 1'b1 : 1'b0);

assign pilot_array_im_address0 = zext_ln56_fu_142_p1;

assign pilot_array_re_address0 = zext_ln56_fu_142_p1;
...
assign sub_ln56_fu_126_p2 = (ap_sig_allocacmp_i - zext_ln54_cast_fu_108_p1);

assign tmp_fu_132_p4 = {{sub_ln56_fu_126_p2[9:2]}};

assign zext_ln54_cast_fu_108_p1 = zext_ln54;

assign zext_ln56_fu_142_p1 = tmp_fu_132_p4;
