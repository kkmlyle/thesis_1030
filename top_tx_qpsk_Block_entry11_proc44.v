...
module top_tx_qpsk_Block_entry11_proc44 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
top_tx_qpsk_Block_entry11_proc44_mapping_ROM_AUTO_1R #(
    .DataWidth( 2 ),
    .AddressRange( 2 ),
    .AddressWidth( 1 ))
mapping_U(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((temp1_im598_full_n == 1'b0) | (temp1_re597_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state18))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((temp1_im598_full_n == 1'b0) | (temp1_re597_full_n == 1'b0))) begin
...
always @ (*) begin
    if ((~((temp1_im598_full_n == 1'b0) | (temp1_re597_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state18))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state18 = ((temp1_im598_full_n == 1'b0) | (temp1_re597_full_n == 1'b0));
end
...
assign icmp_ln592_1_fu_561_p2 = ((tmp_10_fu_551_p4 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln592_fu_318_p2 = ((tmp_7_fu_308_p4 == 8'd0) ? 1'b1 : 1'b0);
...
assign select_ln574_3_fu_535_p3 = ((tmp_9_fu_527_p3[0:0] == 1'b1) ? 16'd65535 : 16'd0);
...
assign temp1_im598_din = select_ln560_1_reg_684;

assign temp1_re597_din = select_ln560_reg_679;

assign tmp_10_fu_551_p4 = {{sh_amt_1_fu_485_p3[11:4]}};

assign tmp_7_fu_308_p4 = {{sh_amt_fu_242_p3[11:4]}};

assign tmp_9_fu_527_p3 = ireg_1_fu_396_p1[32'd63];
...
endmodule //top_tx_qpsk_Block_entry11_proc44
