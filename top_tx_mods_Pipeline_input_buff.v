...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_194)) begin
        if ((icmp_ln106_fu_186_p2 == 1'd0)) begin
            i_fu_60 <= add_ln106_fu_192_p2;
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0))) & (icmp_ln106_fu_186_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln106_fu_186_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1) & (ap_start_int == 1'b1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0))) & (icmp_ln106_fu_186_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
        input1_TREADY = 1'b1;
    end else begin
        input1_TREADY = 1'b0;
    end
...
assign add_ln106_fu_192_p2 = (ap_sig_allocacmp_i_4 + 12'd1);

assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_194 = (~((ap_start_int == 1'b0) | ((input6_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input5_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input4_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input3_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((input2_TVALID == 1'b0) & (icmp_ln106_fu_186_p2 == 1'd0)) | ((icmp_ln106_fu_186_p2 == 1'd0) & (input1_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end
...
assign icmp_ln106_fu_186_p2 = ((ap_sig_allocacmp_i_4 == 12'd3600) ? 1'b1 : 1'b0);
