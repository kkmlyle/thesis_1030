...
always @ (*) begin
    if ((((ap_start == 1'b0) & (1'b1 == ap_CS_fsm_state1)) | (~((temp1_im598_full_n == 1'b0) | (temp1_re597_full_n == 1'b0)) & (1'b1 == ap_CS_fsm_state18)))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
assign icmp_ln592_2_fu_615_p2 = ((tmp_14_fu_605_p4 == 8'd0) ? 1'b1 : 1'b0);

assign icmp_ln592_fu_372_p2 = ((tmp_11_fu_362_p4 == 8'd0) ? 1'b1 : 1'b0);
...
assign select_ln574_5_fu_589_p3 = ((tmp_13_fu_581_p3[0:0] == 1'b1) ? 16'd65535 : 16'd0);
...
assign temp1_im598_din = select_ln560_2_reg_738;

assign temp1_re597_din = select_ln560_reg_733;

assign tmp_11_fu_362_p4 = {{sh_amt_fu_296_p3[11:4]}};

assign tmp_13_fu_581_p3 = ireg_2_fu_450_p1[32'd63];

assign tmp_14_fu_605_p4 = {{sh_amt_2_fu_539_p3[11:4]}};
