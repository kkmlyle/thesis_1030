...
module top_tx_adding_pilot_Pipeline_initial2 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln32_fu_72_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [63:0] i_cast_fu_84_p1;
reg   [9:0] i_fu_32;
wire   [9:0] add_ln32_fu_78_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln32_fu_72_p2 == 1'd0)) begin
            i_fu_32 <= add_ln32_fu_78_p2;
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln32_fu_72_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln32_fu_72_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln32_fu_78_p2 = (ap_sig_allocacmp_i_11 + 10'd1);
...
assign i_cast_fu_84_p1 = ap_sig_allocacmp_i_11;

assign icmp_ln32_fu_72_p2 = ((ap_sig_allocacmp_i_11 == 10'd600) ? 1'b1 : 1'b0);

assign pilot_vle_M_imag_V_address0 = i_cast_fu_84_p1;

assign pilot_vle_M_imag_V_d0 = 15'd0;

assign pilot_vle_M_real_V_address0 = i_cast_fu_84_p1;

assign pilot_vle_M_real_V_d0 = 15'd0;

endmodule //top_tx_adding_pilot_Pipeline_initial2
